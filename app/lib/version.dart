/// Keep in sync with pubspec.yaml's `version:` field, bumped on every
/// release build. Shown as a small footer on the trip list screen so a
...
const String kAppVersion = '1.0.1+13';
